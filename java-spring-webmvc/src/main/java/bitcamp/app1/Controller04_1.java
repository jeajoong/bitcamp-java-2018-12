...
public class Controller04_1 {
  ...
  // 요청 핸들러를 정의할 때 받고 싶은 타입의 아규먼트로 선언하라!
...
//      ServletContext sc, // ServletContext는 파라미터로 받을 수 없다. 예외 발생!
      ...
      PrintWriter out // 클라이언트에게 콘텐트를 출력할 때 사용할 출력 스트림
      ) { 
    
    out.printf("ServletContext: \n", sc != null);
    out.printf("ServletRequest: \n", request != null);
    out.printf("ServletResponse: \n", response != null);
    out.printf("HttpServletRequest: \n", request2 != null);
    out.printf("HttpServletResponse: \n", response2 != null);
    out.printf("HttpSession: \n", session != null);
    out.printf("Map: \n", map != null);
    out.printf("Model: \n", model != null);
