...
public class Test08 {
  ...
  public static void main(String[] args) {
    ...
    switch (op) {
      ...
      //
      case "+": result = study.A08_class2.util.Calculator2.plus(a, b); break;
      case "-": result = study.A08_class2.util.Calculator2.minus(a, b); break;
      case "*": result = study.A08_class2.util.Calculator2.multiple(a, b); break;
      case "/": result = study.A08_class2.util.Calculator2.divide(a, b); break;
      default:
